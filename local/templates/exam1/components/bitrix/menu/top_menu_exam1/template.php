            ...
            <div class="menu-block popup-wrap">
                ...
                <div class="menu popup-block">
                    <ul class="">
                        ...
                        <li class="<? if (isset($arItem["PARAMS"]["CLASS"])) {
                            ?>
        <?= $arItem["PARAMS"]["CLASS"]; ?>
    <? } ?>"><a href="<?= $arItem["LINK"] ?>"
        ...
        <?= $arItem["PARAMS"]["CLASS"]; ?>
    <? } ?>"><a href="<?= $arItem["LINK"] ?>"
                class="<? if ($arItem["SELECTED"]):?>root-item-selected<? else:?>root-item<? endif ?>  <? if ($arItem["PERMISSION"] == "D") {?>denied<? } ?>"><?= $arItem["TEXT"] ?></a>
                                                    </li>
                                                <? else:?>
                                                    <li<? if ($arItem["SELECTED"]):?> class="item-selected"<? endif ?>>
                                                        <a href="<?= $arItem["LINK"] ?>" class=" <? if ($arItem["PERMISSION"] == "D") {?>denied<? } ?>"><?= $arItem["TEXT"] ?></a></li>
                                                <? endif ?>
                                            ...
                                            <? else:?>
                                                ...
                                                <? else:?>
                                                    <li><a href="" class="denied" title="<?= GetMessage(
                                                            "MENU_ITEM_ACCESS_DENIED"
                                                        ) ?>"><?= $arItem["TEXT"] ?></a></li>
                                                <? endif ?>
